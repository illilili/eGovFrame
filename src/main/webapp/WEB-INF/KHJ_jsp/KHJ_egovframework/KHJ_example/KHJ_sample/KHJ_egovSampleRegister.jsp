...
<head>
    ...
    <c:set var="registerFlag" value="${empty KHJ_SampleVO.id ? 'create' : 'modify'}"/>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_selectList() {
           	document.detailForm.action = "<c:url value='/KHJ_egovSampleList.do'/>";
...
<form:form modelAttribute="KHJ_SampleVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    ...
    <!-- 검색조건 유지 -->
    <input type="hidden" name="searchCondition" value="<c:out value='${KHJ_searchVO.searchCondition}'/>"/>
    <input type="hidden" name="searchKeyword" value="<c:out value='${KHJ_searchVO.searchKeyword}'/>"/>
    <input type="hidden" name="pageIndex" value="<c:out value='${KHJ_searchVO.pageIndex}'/>"/>
</form:form>
</body>
</html>