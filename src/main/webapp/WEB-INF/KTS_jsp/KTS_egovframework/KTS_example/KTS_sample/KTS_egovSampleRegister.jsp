...
<head>
    ...
    <c:set var="registerFlag" value="${empty KTS_SampleVO.id ? 'create' : 'modify'}"/>
    ...
    <script type="text/javascript" src="<c:url value='/KTS_cmmn/KTS_validator.do'/>"></script>
    <validator:javascript formName="KTS_SampleVO" staticJavascript="false" xhtml="true" cdata="false"/>
    
    <script type="text/javaScript" language="javascript" defer="defer">
        <!--
        /* 글 목록 화면 function */
        function fn_egov_selectList() {
           	document.detailForm.action = "<c:url value='/KTS_egovSampleList.do'/>";
...
<form:form modelAttribute="KTS_SampleVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    ...
    <!-- 검색조건 유지 -->
    <input type="hidden" name="searchCondition" value="<c:out value='${KTS_searchVO.searchCondition}'/>"/>
    <input type="hidden" name="searchKeyword" value="<c:out value='${KTS_searchVO.searchKeyword}'/>"/>
    <input type="hidden" name="pageIndex" value="<c:out value='${KTS_searchVO.pageIndex}'/>"/>
</form:form>
</body>
</html>