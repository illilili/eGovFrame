...
<head>
    ...
    <c:set var="registerFlag" value="${empty KJG_SampleVO.id ? 'create' : 'modify'}"/>
    ...
    <validator:javascript formName="KJG_SampleVO" staticJavascript="false" xhtml="true" cdata="false"/>
...
<form:form modelAttribute="KJG_SampleVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
